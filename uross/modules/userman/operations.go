...
func (m *uross.Module) Profile(ctx context.Context, token, dbType, project, id string) (int, map[string]interface{}, error) {
	if !m.IsEnabled() {
...
func (m *uross.Module) Profiles(ctx context.Context, token, dbType, project string) (int, map[string]interface{}, error) {
	if !m.IsEnabled() {
		return http.StatusNotFound, nil, errors.New("This feature isn't enabled")
	}
	// Create the find object
...
func (m *uross.Module) EmailSignIn(ctx context.Context, dbType, project, email, password string) (int, map[string]interface{}, error) {
...
func (m *uross.Module) EmailSignUp(ctx context.Context, dbType, project, email, name, password, role string) (int, map[string]interface{}, error) {
	// Allow this feature only if the email sign in function is enabled
	if !m.IsActive("email") {
		return http.StatusNotFound, nil, errors.New("Email sign in feature is not enabled")
	}
...
func (m *uross.Module) EmailEditProfile(ctx context.Context, token, dbType, project, id, email, name, password string) (int, map[string]interface{}, error) {
	// Allow this feature only if the email sign in function is enabled
	if !m.IsEnabled() {
		return http.StatusNotFound, nil, errors.New("Email sign in feature is not enabled")
	}
